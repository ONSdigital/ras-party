...
def get_business_by_ref(ref):
    ...
    # retrieve_associations = True if retrieve_associations and retrieve_associations.lower() == "true" else False
    business = business_controller.get_business_by_ref(True, ref)
