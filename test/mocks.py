...
class MockRequests:
    class Get:
        ...
        def __call__(self, uri, *args, **kwargs):
            ...
            try:
                return {
                    "http://mockhost:1111/cases/iac/fb747cq725lj": MockResponse(
                        get_case_by_iac.response
                    ),
                    "http://mockhost:1111/cases/partyid/438df969-7c9c-4cd4-a89b-ac88cf0bfdf3": MockResponse(
                        get_cases_by_party.response
                    ),
                    "http://mockhost:1111/cases/partyid/3b136c4b-7a14-4904-9e01-13364dd7b972": MockResponse(
                        get_cases_by_party.response
                    ),
                    "http://mockhost:1111/casegroups/partyid/3b136c4b-7a14-4904-9e01-13364dd7b972": MockResponse(
                        get_casegroups_by_party.response
                    ),
                    ...
                    "http://mockhost:3333/surveys/cb0711c3-0ac8-41d3-ae0e-567e5ea1ef87": MockResponse(
                        get_survey_by_id.response
                    ),
                    "http://mockhost:6666/iacs/fb747cq725lj": MockResponse(
                        get_iac.response
                    ),
                    "http://mockhost:1111/cases/casegroupid/612f5c34-7e11-4740-8e24-cb321a86a917": MockResponse(
                        get_cases_by_party.response
                    ),
                }[uri]
            except KeyError:
