...
class TestParties(PartyTestClient):
    ...
    def test_get_business_by_id_returns_correct_representation(self):
        ...
        self.assertEqual(
            response.get("sampleSummaryId"), mock_business["sampleSummaryId"]
        )
        self.assertEqual(response.get("name"), mock_business.get("name"))
        self.assertEqual(
            response.get("trading_as"), "Tradstyle-1 Tradstyle-2 Tradstyle-3"
        )
    ...
    def test_get_business_by_ids_returns_correct_representation(self):
        ...
        self.assertEqual(
            res_dict[party_id_1].get("sampleSummaryId"),
        ...
        self.assertEqual(
            res_dict[party_id_2].get("sampleSummaryId"),
