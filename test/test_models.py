    ...
    def test_business_adds_versioned_attributes(self):
        party_data = {'sampleUnitType': 'B',
                      ...
                      'attributes': {'ruref': '428533294', 'birthdate': '1/1/2001', 'checkletter': 'A', 'currency': 'S',
                                     ...
                                     'entremkr': 'Entremkr', 'formType': 'FormType', 'formtype': 'formtype',
                                     'froempment': 8, 'frosic2007': 'frosic2007', 'frosic92': 'frosic92', 'frotover': 9,
                                     'inclexcl': 'inclexcl', 'legalstatus': 'Legal Status', 'region': 'UK',
